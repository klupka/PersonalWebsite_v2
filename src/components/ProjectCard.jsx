...
const ProjectCard = ({
    ...
    if (tags !== undefined) {
        ...
        return (
            <a
                className={`w-full flex rounded-3xl p-5 group transition-[transform, opacity] duration-100 gap-5 ease-in-out opacity-100 bg-foreground hover:bg-highlightForeground ${
